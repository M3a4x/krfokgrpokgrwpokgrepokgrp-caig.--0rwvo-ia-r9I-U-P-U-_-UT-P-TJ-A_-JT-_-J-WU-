...
client.on('ready', function(){ // Leaked by [ @M3a4x ]
    var ms = 30000 ;
    var setGame = [`RevengeMC Community `,` RevengeMC Server By M3a4x.js#1884 !`];
    var i = -1;
    var j = 0;
...
.setTitle('RevengeMC Server Info')
...
var message = "zg";
         const embed = new Discord.RichEmbed()
     .setColor("GOLD")
     .setTitle('RevengeMC Server Link Click Here .!')
     .setURL('https://discord.gg/hp8RNSY')
  .setDescription(`**
  New Server Add RevengeMC Server ✅
...
var message = "zg";
     ...
     .setURL('https://discord.gg/hp8RNSY')
  .setDescription(`**
  Server Kicked RevengeMC Server :cry:
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("465340887279468564").sendEmbed(embed)
});
